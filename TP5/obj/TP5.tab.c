...
tNodoTablaDeSimb* inicializarNodoConTipo(char* tipo);
...
static const yytype_uint16 yyrline[] =
{
     ...
     144,   147,   148,   151,   152,   153,   154,   158,   158,   158,
     158,   161,   161,   164,   165,   165,   166,   167,   170,   170,
     171,   174,   175,   176,   179,   179,   180,   181,   184,   185,
     185,   186,   187,   190,   191,   194,   195,   196,   197,   200,
     201,   202,   203,   206,   207,   210,   210,   211,   214,   214,
     216,   217,   221,   222,   225,   226,   229,   230,   231,   234,
     235,   235,   236,   239,   240,   241,   244,   245,   246,   247,
     248,   256,   257,   258,   259,   260,   261,   262,   263,   264,
...
/* Line 1455 of yacc.c  */
#line 128 "../src/TP5.y"
    {nodo2 = nodo = inicializarNodoConTipo((yyvsp[(1) - (1)].cadena));;}
    break;
...
/* Line 1455 of yacc.c  */
#line 158 "../src/TP5.y"
    {nodo->identificador = strdup((yyvsp[(2) - (2)].cadena)); agregarATS(&nodo);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 165 "../src/TP5.y"
    {nodo = inicializarNodoConTipo(nodo->tipo);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 170 "../src/TP5.y"
    {nodo2->validar = 1; nodo2->identificador = strdup((yyvsp[(1) - (1)].cadena));;}
    break;
...
void validarExistenciaYTipo(int a,tNodoTablaDeSimb* nodoActual, char* identificador){
	if(nodoActual){
		if(a != nodoActual->validar){
			printf("El identificador %s no corresponde con su uso",identificador); //que rompa y no siga analizando
		}
	}
	else if(a)
	{
...
void agregarATS(tNodoTablaDeSimb** nodo)
{
	...
	printf("Se va a agregar a la tabla de simbolos el id: %s\n", (*nodo)->identificador);
	(*nodo)->sgte = tablaDeSimb;
	tablaDeSimb = (*nodo);
	printf("Se agrego con exito el id: %s\n", (*nodo)->identificador);
}
